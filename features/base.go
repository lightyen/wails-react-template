...
func (b *Base) OnStartup(ctx context.Context) {
	...
	runtime.EventsOn(b.ctx, "ready", func(_ ...interface{}) {
		if files != nil {
...
func (b *Base) OnDomReady(ctx context.Context) {
	//
}
...
func (b *Base) SetRoutes(e *gin.Engine) {
	img := e.Group("/img")
	{
...
func isImage(filename string) bool {
	...
	defer f.Close()
	e, _ := imagemeta.Parse(f)
	if e == nil || e.ImageType() == imagetype.ImageUnknown {
		b := make([]byte, 512)
